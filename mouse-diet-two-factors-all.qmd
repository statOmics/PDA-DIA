...
```{r}
common_precursors <- qf[["precursors_norm"]] |> assay() |> na.exclude() |> rownames()
qf[common_precursors, , "precursors_norm"] |>
  longForm(colvars = colnames(colData(qf))) |> 
  data.frame() |> 
  filter(!is.na(value)) |>
  ggplot() + 
...
```{r}
contrasts <- c(
  " - (dietHFD + diethigh + dietlow) / 3 = 0", 
  "dietHFD - (diethigh + dietlow) / 3 = 0",
  "diethigh - (dietHFD + dietlow) / 3 = 0", 
  "dietlow - (dietHFD + diethigh) / 3 = 0",
 " - (dietHFD + dietHFD:sexm + diethigh + diethigh:sexm + dietlow + dietlow:sexm) / 3 = 0", 
  "dietHFD + dietHFD:sexm - (diethigh + diethigh:sexm + dietlow + dietlow:sexm) / 3 = 0",
  "diethigh + diethigh:sexm - (dietHFD + dietHFD:sexm + dietlow + dietlow:sexm) / 3 = 0", 
  "dietlow + dietlow:sexm - (dietHFD + dietHFD:sexm + diethigh + diethigh:sexm) / 3 = 0",
 " - (dietHFD:sexm  + diethigh:sexm + dietlow:sexm) / 3 = 0", 
  "dietHFD:sexm - (diethigh:sexm + dietlow:sexm) / 3 = 0",
  "diethigh:sexm - (dietHFD:sexm + dietlow:sexm) / 3 = 0", 
  "dietlow:sexm - (dietHFD:sexm + diethigh:sexm) / 3 = 0")
