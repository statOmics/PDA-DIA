# Tutorial: median normalisation + median polish summarisation {-}
...
Note, that we also have to set na.rm = TRUE as an optional argument to handle missing data. 
